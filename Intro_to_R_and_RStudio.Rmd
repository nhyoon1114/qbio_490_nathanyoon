...
```{r setup Exercise 2.3}
    ...
    knitr::opts_knit$set(root.dir = normalizePath("C:/Users/Windows/Desktop/qbio_490_nathanyoon")) 
```
...
age <- 21
birthday <- "11/14/2001"
three_fav_colors <- c("green", "white", "black")
...
mode(list_of_numbers) ##this gives the type of the variable??
...
```{r Exercise 9.2}
# write code here
mtcars$transmission <- ifelse(mtcars[ , 9] == 1, "manual", "automatic")
mtcars$transmission
mtcars[ , 9]
...
# write code here
colnames(mtcars)
mtcars_no_am <- mtcars[ , c(1:8, 10:12)]
```
